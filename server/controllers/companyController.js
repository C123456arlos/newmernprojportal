...
export const registerCompany = async (req, res) => {
    ...
    try {
        ...
        res.json({
            success: true, company: { _id: company._id, name: company.name, email: company.email, image: company.image },
...
export const postJob = async (req, res) => {
    ...
    try {
        const newJob = new Job({
            title, description, location, salary, companyId:companyId, date:Date.now(), level, category
        })
        await newJob.save()
