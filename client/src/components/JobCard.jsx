  ...
  return (
      <div className='border p-6 shadow rounded'>
          <div className='flex justify-between items-center'>
              <img className='h-8' src={job.companyId?.image}></img>
          </div>
          ...
          <div className='mt-4 flex gap-4 text-sm'>
              ...
              <button onClick={()=>{navigate(`/apply-job/${job._id}`); scrollTo(0,0)}}  className='text-gray-500 border border-gray-500 rounded px-4 py-2z'>learn more</button>
          </div>
    </div>
  )
}
